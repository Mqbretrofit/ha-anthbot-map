import { AnthbotMapRenderer } from "./renderer.js?v=99";
import { LANGUAGES, resolveLanguage, translate } from "./i18n.js?v=99";
import {
  adjustCalibration,
  cardToYaml,
  readCalibration,
...
class AnthbotMapCard extends HTMLElement {
  ...
  render() {
    ...
    root.innerHTML = `
      <ha-card class="${cardClasses}">
        <link rel="stylesheet" href="${this.resolveAsset("styles.css?v=99")}">
  ...
  rendererOptions() {
    return {
      ...
      robotImage: this.config.robot_image || this.config.robotImage || this.resolveAsset("robot.png?v=99"),
