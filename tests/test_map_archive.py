...
PACKAGE = "custom_components.anthbot_genie_plus"
...
def _load_api_module():
    ...
    package.__path__ = [str(ROOT / "custom_components/anthbot_genie_plus")]
    ...
    if const_name not in sys.modules:
        const_spec = importlib.util.spec_from_file_location(
            const_name,
            ROOT / "custom_components/anthbot_genie_plus/const.py",
        )
    ...
    api_spec = importlib.util.spec_from_file_location(
        api_name,
        ROOT / "custom_components/anthbot_genie_plus/api.py",
    )
